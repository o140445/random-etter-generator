      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <section className="mt-12">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold">How to generate a random letter in Python?</h3>
              <pre className="bg-gray-100 dark:bg-gray-800 rounded p-2 text-sm overflow-x-auto"><code>import random
import string
print(random.choice(string.ascii_letters))</code></pre>
            </div>
            <div>
...
print(''.join(random.choices(string.ascii_lowercase, k=5)))</code></pre>
            ...
            <div>
              ...
              <p>A random letter generator is an online tool that creates random letters, numbers, or symbols for use in passwords, games, testing, and more.</p>
            </div>
          </div>
        </section>
      </div>
