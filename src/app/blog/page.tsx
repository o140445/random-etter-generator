  ...
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      ...
      <ul className="space-y-6">
        <li>
          <a href="/blog/why-use-a-random-letter-generator" className="text-xl font-semibold text-blue-600 hover:underline">Why Use a Random Letter Generator?</a>
        ...
        <li>
          <a href="/blog/how-to-generate-random-letters-in-python" className="text-xl font-semibold text-blue-600 hover:underline">How to Generate Random Letters in Python</a>
        ...
        <li>
          <a href="/blog/random-letters-vs-random-words" className="text-xl font-semibold text-blue-600 hover:underline">Random Letters vs. Random Words: Which to Use?</a>
