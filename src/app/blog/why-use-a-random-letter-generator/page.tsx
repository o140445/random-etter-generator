...
export default function WhyUseRandomLetterGenerator() {
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      ...
      <p className="mb-4 text-gray-700 dark:text-gray-300">
        Whether you need a secure password, a fun classroom activity, or a creative spark, a random letter generator is a versatile tool for everyone. Try it now on <a href="/" className="text-blue-600 hover:underline">random-letter-generator.com</a>!
      </p>
    </main>
  );
} 