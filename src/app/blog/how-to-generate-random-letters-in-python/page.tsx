...
print(random.choice(string.ascii_letters))  # a-z, A-Z</code></pre>
      ...
      <p className="mb-4 text-gray-700 dark:text-gray-300">
        With just a few lines of code, you can generate random letters in Python for any purpose. Try it out, or use our <Link href="/" className="text-blue-600 hover:underline">online random letter generator</Link> for instant results!
      </p>
    </main>
  );
} 